            ...
            <div className="row g-0">
              <div className="col-4">
                <img
                  src={f.photos[0]}
                  height={205}
                  className="imagelist rounded-start"
                  alt="..."
                />
              </div>
              <div className="col-7 ">
  ...
  return (
    <>
      <div className="container back">
        <div className="row">
          <div className="m-3 title">Homes for Buy</div>
        </div>
          ...
          <div className="col-4">
            <div className="row">
              <div className="card" style={{ width: "380px" }}>
                ...
                <div></div>
                {/* <div>
                  <div className="searchtitle">Price Range</div>
                  <div className="row">
                    {priceRanges.map((range, index) => (
                      <div key={index} style={{paddingLeft:"20px"}} className="col-12">
                        <label >
                          <input
                            type="checkbox"
                ...
                {/* <div>
                  <div className="searchtitle">Square Feet</div>

  ...
  return (
    <>
      <div className="container back">
        <div className="row">
          <div className="m-3 title">Homes for Sell</div>
        </div>
        <div className="row body searchbar">
          ...
          {isGrid ? (
            <div className="col">
              <div className="row">
                <div className="col-7">Showing {result.filter(item => item !== undefined).length} results</div>
            ...
            <div className="col">
              <div className="row">
                <div className="col-7">Showing {resultList.filter(item => item !== undefined).length} results</div>
                <div className="col-1 fw-lighter text-body-tertiary">
                  Sort By
                </div>
                <div className="col-2">
